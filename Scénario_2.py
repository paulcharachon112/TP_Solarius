...
def lights():
    """ randomimizing movements to comprare 4 light values, and finds the biggest value"""
    """collecting light value for up"""
    servo_verticale(int(position_verticale) + 10)
    lights_up = cp.light  # collecting light data
    """collecting light value for down; -10 for other side (+ -10 to return to orignial spot) """
    ...
    """collecting light value for droite; -10 for other side (+-10 to return to orignial spot) """
    servo_horizontale(int(position_horizontale) - 10)
    lights_droite = cp.light  # collecting light data
    # returning to original position
    servo_horizontale(int(position_horizontale))
    """comparing all of the values and finding the biggest one, storing it in a new variable"""
